...
<body>
	<center>
		<jsp:include page="accSea.jsp"></jsp:include>
	...
	<table border="3" align="center" width="500" hight="300">
		<tr style='background: white'>
			<td style='color: black'>Account Number</td>
		...
		<tr>
			<td style='color: white' colspan="12" align="center"><a
				href="accountSearch.jsp"><input type="submit" value="back"></a></td>
		</tr>
	...
	out.println("<h2 style='color:white'>This Account No. Not Available Try Again...");
	%>
	<br>
	<tr>
		<td style='color: white'><a href="accountSearch.jsp"><input
