...
<body>
	<jsp:include page="accUpd.jsp"></jsp:include>
	<%
	...
	%>
	<center>
		<h1 style='color: white'>~Account Update Detail~</h1>
		<form action="accUpdate.jsp">
			<table border="3">
			...
			<%-- 	<br>
			<tr>
				<td style='color: white' colspan="2" align="center"><input
					type="submit" value="Update">&nbsp; &nbsp;<a
					href='showAllDetails.jsp'><input type="back" value="back"></a></td>
			</tr>
			--%>
			<br>
	...
	out.println("<h1 style='color:white'>Account Detail Not Available....");
	}
	con.close();
	} catch (Exception e) {
	e.printStackTrace();
